...
public class DBInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            throw new BusNotFoundException("Error al buscar o crear el bus con placa ABC123:);
        }

        try {
            if(busRepository.findBusByPlaca("DEF456") == null) { busesToSave.add(new Bus("DEF456", "2021")); }
        } catch (Exception e) {
            throw new BusNotFoundException("Error al buscar o crear el bus con placa DEF456: " + e.getMessage());
        }

        try {
            if(busRepository.findBusByPlaca("GHI789") == null) { busesToSave.add(new Bus("GHI789", "2022")); }
        } catch (Exception e) {
            throw new BusNotFoundException("Error al buscar o crear el bus con placa GHI789: " + e.getMessage());
        }
        ...
        try {
            ...
            throw new HorarioNotFoundException("Error al buscar o crear el horario para Lunes de 6:00 a 8:00: " + e.getMessage());
        }
        ...
        try {
            ...
            throw new HorarioNotFoundException("Error al buscar o crear el horario para Martes de 9:00 a 11:00: " + e.getMessage());
        }
        ...
        try {
            ...
            throw new HorarioNotFoundException("Error al buscar o crear el horario para Miércoles de 12:00 a 14:00: " + e.getMessage());
        }
